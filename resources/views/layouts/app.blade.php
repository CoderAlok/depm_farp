                                    ...
                                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                        ...
                                        <div class="info-card-text">
                                            <div class="fs-lg text-truncate text-truncate-lg">
                                                {{ Auth::guard('exporter')->user()->name }}
                                            </div>
                                            <span
                                                class="text-truncate text-truncate-md opacity-80">{{ Auth::guard('exporter')->user()->email ?? '' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="dropdown-divider m-0"></div>
                                @if (Auth::guard('exporter')->user()->track_status == 1)
                                    <a href="{{ route('exporter.profile') }}" class="dropdown-item">
