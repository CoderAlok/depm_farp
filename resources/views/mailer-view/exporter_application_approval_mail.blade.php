...
<body>
    ...
    @if ($data->regsitration_status === 1)
        <p>Congratulations, your application has been approved. Following are the credentials that you
            will require to log into the exporter portal.</p>
    ...
    @else
        <p>Sorry, your application has been rejected. Here is a remarks form the higher authority that has
