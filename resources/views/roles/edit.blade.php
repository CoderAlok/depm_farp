            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="name" placeholder="Enter New Role Name"
                                value="{{ $role->name }}">
                        </div>
                    </div>
                        ...
                        @foreach ($permission->chunk(5) as $chunk)
                            <tr>
                                @foreach ($chunk as $key => $value)
                                    <td><input type="checkbox" id="md_checkbox_{{ $key }}"
                                            class="filled-in chk-col-primary" value="{{ $value->id }}"
                                            name="permission[]"
