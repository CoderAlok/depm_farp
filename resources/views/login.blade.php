                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-6 col-lg-7 hidden-sm-down">
                            <h3 class="fs-xxl fw-500 mt-4 text-white mb-5">
                                ...
                                <small class="h6 fw-300 mt-3 mb-5 text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat..</small>
                            </h3>
                            ...
                            <div class="d-sm-flex flex-column align-items-center justify-content-center d-md-block mb-3">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                <ul class="nav nav-pills justify-content-center" role="tablist">
                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#js_change_pill_direction-1">Exporter</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#js_change_pill_direction-2">User</a></li>
                                </ul>
                                <div class="tab-content py-3">
                                        ...
                                        <form id="js-login" novalidate="" action="intel_analytics_dashboard.html">
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-6 pr-lg-1 my-2">
                                                    <a type="button" class="btn bg-clr-1 text-white btn-block btn-sm" href="register.html">Register</a>                                                      
                                                </div>
                                                <div class="col-lg-6 pl-lg-1 my-2">
                                                    <button id="js-login-btn" type="submit" class="btn btn-danger btn-block btn-sm">Signup</button>
                                                </div>
                                            </div>
                                        </form>                                                
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="js_change_pill_direction-2" role="tabpanel">
                                        <form id="js-login" novalidate="" action="intel_analytics_dashboard.html">
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-6 pr-lg-1 my-2">
                                                    <a type="button" class="btn btn-info btn-block btn-sm" href="register.html">Register</a>
                                                </div>
                                                <div class="col-lg-6 pl-lg-1 my-2">
                                                    <button id="js-login-btn" type="submit" class="btn btn-danger btn-block btn-sm">Signup</button>
                                                </div>
